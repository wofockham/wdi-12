...
var lifeTimeSupply = function (currentAge, maximumAge, amountPerDay) {
  var amountPerYear = amountPerDay * 365.25;

  var yearsRemaining = maximumAge - currentAge;

  var lifeTimeSupply = Math.ceil(amountPerYear * yearsRemaining);

  console.log('You will need ' + lifeTimeSupply +
              ' to last you until the ripe old age of ' + maximumAge);
}

lifeTimeSupply(37, 55, 17);
lifeTimeSupply(37, 55, 6);
